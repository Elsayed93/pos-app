                                    ...
                                    <div class="panel panel-info">
                                        ...
                                        <div id="{{ str_replace(' ', '-', $category->name) }}"
                                            ...
                                            <div class="panel-body">
                                                ...
                                                @else
                                                    <h5>@lang('site.there is no any products')</h5>
                                                @endif
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-header">
                            ...
                            <h3 class="box-title">@lang('orders.orders')</h3>
                        ...
                        <div class="box-body">
                            ...
                            <form action="{{ route('dashboard.orders.store', $client->id) }}" method="post">
                                ...
                                <button class="btn btn-primary btn-block disabled" id="add-order-form-btn"><i
                                        class="fa fa-plus"></i> @lang('orders.Add Order')</button>
